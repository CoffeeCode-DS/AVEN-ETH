...
export default function ClientDashboard() {
  ...
  return (
    ...
    >
      {/* 1. Top Git CLI Alert / Quick Connect Banner (Matching media_1788022200752.png) */}
        ...
        <div className="flex items-center gap-3.5">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 font-mono mt-0.5">
              Run <code className="text-[#818CF8] bg-white/[0.06] px-1.5 py-0.5 rounded">aven watch --agreement [id]</code> locally
            </p>
          </div>
        </div>
      ...
      {/* 2. 3 Bento Action Cards (Exact Replica of 3-Column Bento from media_1788022200752.png) */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-mono text-slate-400">GitHub &middot; GitLab</span>
              </div>
            ...
            <h3 className="text-base font-medium text-white mb-1.5">Connect Git CLI Watcher</h3>
        ...
        <div className="p-5 rounded-2xl bg-[#0A0A0A] border border-white/[0.08] flex flex-col justify-between shadow-xl hover:border-white/[0.14] transition-all">
          <div>
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                <span className="p-1.5 rounded-lg bg-white/[0.06] text-[#818CF8]">
                  <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
                    <path d="M12 2L3 7L12 12L21 7L12 2Z" />
                  </svg>
                </span>
                <span className="text-xs font-mono text-slate-400">Vault Contract</span>
              </div>
            ...
            <h3 className="text-base font-medium text-white mb-1.5">Non-Custodial Stream Vaults</h3>
            <p className="text-xs text-slate-400 leading-relaxed font-normal">
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-mono text-slate-400">EAS Protocol</span>
              </div>
              <span className="px-2 py-0.5 rounded-full bg-white/[0.08] text-slate-300 text-[10px] font-mono font-medium border border-white/[0.1]">
                Beta
              </span>
            </div>
            <h3 className="text-base font-medium text-white mb-1.5">Ethereum Attestation Engine</h3>
            <p className="text-xs text-slate-400 leading-relaxed font-normal">
      ...
      {data && (
        <>
          ...
          {/* 4. What's New In AVEN Banner (Matching media_1788022200752.png bottom section) */}
          <div className="mb-8 p-5 rounded-2xl bg-[#0A0A0A] border border-white/[0.08] shadow-xl">
            <div className="flex items-center gap-2 mb-3">
              <span className="text-[10px] font-mono font-bold tracking-wider text-[#818CF8] uppercase">
            ...
            <div className="space-y-2.5 text-xs text-slate-300 font-sans">
              <div className="flex items-center gap-2">
                ...
                <Link to="/agreements" className="text-[#818CF8] hover:underline font-mono ml-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <Link to="/attestations" className="text-[#818CF8] hover:underline font-mono ml-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <Link to="/security" className="text-[#818CF8] hover:underline font-mono ml-1">
          ...
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-base font-medium text-white">Active Payment Streams</h2>
